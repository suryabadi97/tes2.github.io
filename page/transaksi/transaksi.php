...
<form  method="POST" >
               ...
               <a href="?page=transaksi&aksi=tambah" class="btn btn-default" style="margin-top: 45px;"  title=""><i class="fa fa-plus"></i> Tambah Tagihan</a>
                ...
                <tr>
                  ...
                  <td> 
                    ...
                    <a  href="?page=transaksi&aksi=bayar&id=<?php echo $data['id_tagihan'] ;?>" class="btn btn-primary btn-xs" title=""><i class="fa fa-money"></i>  BAYAR</a>

                    <a  href="https://api.whatsapp.com/send?phone=<?php echo $no_hp ?>&text=Kepada Pelanggan Wifi Bapak/Ibu: <?php echo $data['nama_pelanggan']?>, alamat: <?php echo $data['alamat']?>,  Paket: <?php echo  $data['nama_paket']?>,  Total Tagihan:  Rp <?php echo number_format($data['jml_bayar'])?>,  Pembayaran mulai tanggal 1-10 tiap bulanya,  terima kasih" target="blank" class="btn btn-success btn-xs"> <i class="fa  fa-whatsapp"></i> Kirim WA</a>
                  ...
                  <td> 
                    <a  href="?page=transaksi&aksi=hapus&id=<?php echo $data['id_tagihan'] ;?>" class="btn btn-danger btn-xs" title=""><i class="fa fa-trash"></i> BATAL BAYAR</a>
    ...
    <?php if ($jumlah_data>0) { ?>
     ...
     <a target="blank" href="page/transaksi/cetak_semua.php?bulan=<?php echo $bulan ?>&tahun=<?php echo $tahun ?>" class="btn btn-info" style="margin-top: 10px;"  title=""><i class="fa fa-print"></i> Cetak Tagihan</a>
